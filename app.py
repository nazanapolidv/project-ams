...
from models import db, Usuario, Pedido, Producto, Contenedor, Revision, RegestionEnvios, ItemPedido, Cliente, Deposito
from datetime import date
import os
...
@app.route('/cliente/nuevo_pedido', methods=['GET', 'POST'])
def nuevo_pedido():
    if not g.user or g.user.rol.lower() != 'cliente':
